...
import { playModalSound, playImagePickerSound } from "../../utils/soundUtils";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <TouchableOpacity 
            onPress={() => profileImage ? setShowImageViewer(true) : setShowImagePicker(true)} 
            activeOpacity={0.8}
          >
            {profileImage ? (
              <View style={styles.avatarContainer}>
                <Animated.Image 
                  ...
                  style={[styles.avatarImage, { opacity: profileImageOpacity }]} 
                  onError={(error) => {
                ...
                />
                <TouchableOpacity 
                  style={[styles.addIconContainer, { backgroundColor: colors.background }]}
                  onPress={(e) => {
                    e.stopPropagation();
        ...
        >
          ...
          <Text style={styles.appDescription}>
            Asisten Chatbot AI v2.0
          </Text>
          <Text style={styles.appCopyright}>
            © 2026 Asisten Chatbot AI. All rights reserved.
          </Text>
        </View>
