...
import { playModalSound } from "../../utils/soundUtils";
      ...
      {showInactiveModal && (
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <Text style={styles.modalTitle}>Akun Tidak Aktif</Text>
            <Text style={styles.modalMessage}>
              Akun Anda belum diaktifkan oleh administrator. Silakan hubungi admin untuk bantuan lebih lanjut.
            </Text>
            <TouchableOpacity
